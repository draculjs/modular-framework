    ...
    en: {
        user: {
            audit: {
                ...
                changePasswordAdmin: 'user {username}\'s password was changed by administrator',
    ...
    es: {
        user: {
            audit: {
                ...
                changePasswordAdmin: 'la contraseña de {username} fue modificada por administrator',
    ...
    pt: {
        user: {
            audit: {
                ...
                changePasswordAdmin: 'a senha de {username} foi alterada pelo administrador',
