<template>
  <v-container>
    <v-form ref="form" autocomplete="off" @submit.prevent="$emit('save')">
      <v-row>
        <v-col cols="12">
          <span class="headline">{{ $t('media.userStorage.cliente') }}: {{ form.name }}</span>
        </v-col>
        <v-col cols="4">
          <v-text-field
        ...
        <v-col cols="6" class="ml-12">
          <span
              class="headline">{{ $t('media.userStorage.usedPercentage') }} {{ percentageUsed(form) }}</span>
        </v-col>
      </v-row>
      <v-row>
        <v-col cols="4">
        ...
        <v-col cols="6" class="ml-12">
          ...
          <span class="headline">{{ $t('media.userStorage.fileSizeLimit') }}</span>
        </v-col>
      </v-row>
      <v-row>
        <v-col cols="4">
      ...
      <v-row align="center">
        ...
        <v-col cols="7" class="ml-12">
          <span class="headline">{{ $t('media.userStorage.deleteByLastAccess') }}</span>
        </v-col>
      </v-row>
      <v-row align="center">
        <v-col cols="4" class="pa-0 pl-2">
        ...
        <v-col cols="7" class="ml-12">
          <span class="headline">{{ $t('media.userStorage.deleteByDateCreated') }}</span>
        </v-col>
      </v-row>
    </v-form>
  </v-container>
